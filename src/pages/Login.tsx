      ...
      overflow: 'auto'
        ...
        maxWidth: {
          ...
          mb: {
            ...
            <Box component="img" src="/lovable-uploads/ed53daea-0c4e-4932-ad15-c29208c6a5ff.png" alt="Logo" sx={{
            height: {
              xs: 35,
              sm: 40,
              md: 50
        ...
        maxWidth: {
          ...
          <SecondaryButton fullWidth onClick={handleGoogleLogin} startIcon={<Box component="img" src="https://developers.google.com/identity/images/g-logo.png" alt="Google" sx={{
          width: 18,
          height: 18
        }} />} sx={{
          mb: 3,
