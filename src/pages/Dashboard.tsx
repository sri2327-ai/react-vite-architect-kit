  ...
  const drawer = <Box sx={{
    ...
    background: bravoColors.primary
      ...
      justifyContent: 'center'
        ...
        {desktopCollapsed && !isMobile && <Box component="img" src="/lovable-uploads/ed53daea-0c4e-4932-ad15-c29208c6a5ff.png" alt="S10.AI Logo" sx={{
        height: 32,
        width: 32,
        margin: '0 auto'
      }} />}
      ...
      pt: 2
        ...
        {menuItems.map(item => <ListItem key={item.id} disablePadding sx={{
        mb: 0.5
      }}>
            <ListItemButton onClick={() => handleMenuItemClick(item.id)} selected={activeMenuItem === item.id} sx={{
          mx: 2,
          borderRadius: 2,
          minHeight: 48,
          ...
          '&:hover': {
            ...
            justifyContent: 'center'
              ...
              {(!desktopCollapsed || isMobile) && <ListItemText primary={item.label} primaryTypographyProps={{
      ...
      borderColor: 'divider'
          ...
          <IconButton onClick={handleDesktopToggle} sx={{
        width: '100%',
        color: 'white',
        '&:hover': {
          backgroundColor: 'rgba(255, 255, 255, 0.1)'
