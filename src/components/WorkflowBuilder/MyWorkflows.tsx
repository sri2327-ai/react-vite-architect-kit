...
import { Box, Typography, Card, CardContent, Button, Chip, IconButton, Grid, Stack, Paper, Container, List, ListItem, ListItemText, ListItemIcon, Collapse, Divider, Alert, useTheme, useMediaQuery, Menu, MenuItem, Fab } from '@mui/material';
import { alpha } from '@mui/material/styles';
import { Add as AddIcon, PlayArrow as PlayIcon, Pause as PauseIcon, Edit as EditIcon, Delete as DeleteIcon, ContentCopy as CopyIcon, Share as ShareIcon, MoreVert as MoreVertIcon, Star as StarIcon, Favorite as FavoriteIcon, FavoriteBorder as FavoriteBorderIcon, CheckCircle as CheckCircleIcon, Schedule as ScheduleIcon, Assignment as AssignmentIcon, ExpandMore as ExpandMoreIcon, ExpandLess as ExpandLessIcon, TrendingUp as TrendingIcon, AccessTime as TimeIcon, AccountTree as WorkflowIcon } from '@mui/icons-material';
...
const MyWorkflows: React.FC<MyWorkflowsProps> = ({
  ...
  const getStatusChip = (workflow: Workflow) => {
    if (workflow.isActive) {
      return <Chip label="Active" size="small" color="success" icon={<CheckCircleIcon />} variant="filled" sx={{
        fontWeight: 600,
        fontSize: '0.75rem'
      }} />;
    } else {
      return <Chip label="Inactive" size="small" color="default" icon={<PauseIcon />} variant="outlined" sx={{
        fontWeight: 600,
        fontSize: '0.75rem'
      }} />;
    }
      ...
      py: {
        ...
        p: {
          ...
          borderColor: 'grey.300'
            ...
            <Typography variant={isSmallMobile ? "h5" : isMobile ? "h4" : "h4"} gutterBottom sx={{
            fontWeight: 600,
            color: 'text.primary',
            fontSize: {
              xs: '1.25rem',
            ...
            justifyContent: 'center'
              ...
              <Button variant="contained" size={isSmallMobile ? "medium" : "large"} startIcon={<AddIcon />} sx={{
              borderRadius: 2,
              fontSize: {
                xs: '0.875rem',
                sm: '1rem'
              ...
              <Button variant="outlined" size={isSmallMobile ? "medium" : "large"} startIcon={<AddIcon />} sx={{
              borderRadius: 2,
              fontSize: {
                xs: '0.875rem',
                sm: '1rem'
      ...
      position: 'relative'
        ...
        <Box>
          ...
          mb: {
            ...
            <Typography variant={isSmallMobile ? "h6" : isMobile ? "h5" : "h5"} gutterBottom sx={{
            fontWeight: 600,
            color: 'text.primary',
            fontSize: {
              xs: '1.125rem',
            ...
            '&:hover': {
                ...
                mb: {
                  ...
                  mr: 2
                    ...
                    gap: 0.5
                        ...
                        <Chip label={workflow.category} size="small" color="info" variant="outlined" sx={{
                      fontSize: '0.7rem'
                    }} />
                        <Chip label={workflow.ehrSystem} size="small" color="primary" variant="outlined" sx={{
                      fontSize: '0.7rem'
                    }} />
                      </Stack>
                    </Box>
                    <IconButton size="small" onClick={e => handleMenuOpen(e, workflow.id)} sx={{
                  mt: -1
                }}>
                      <MoreVertIcon />
                    </IconButton>
                ...
                mb: {
                  ...
                  mb: 1
                    ...
                    fontSize: {
                      ...
                      <IconButton size="small" onClick={() => setExpandedWorkflow(expandedWorkflow === workflow.id ? null : workflow.id)}>
                  ...
                  py: 0
                      ...
                      {workflow.blocks.slice(0, 2).map(block => <ListItem key={block.id} disableGutters sx={{
                    py: 0.5
                  }}>
                          <ListItemIcon sx={{
                      minWidth: 'auto',
                      mr: 1
                        ...
                        alignItems: 'center'
                          ...
                          <ListItemText primary={block.name} secondary={block.description} primaryTypographyProps={{
                    ...
                    py: 0
                        ...
                        {workflow.blocks.slice(2).map(block => <ListItem key={block.id} disableGutters sx={{
                      py: 0.5
                    }}>
                            <ListItemIcon sx={{
                        minWidth: 'auto',
                    ...
                    {workflow.blocks.length > 2 && expandedWorkflow !== workflow.id && <Typography variant="caption" color="text.secondary" sx={{
                  display: 'block',
                  textAlign: 'right',
                  fontSize: {
                    xs: '0.7rem',
              ...
              pt: 0
                  ...
                  <Stack direction="row" spacing={1}>
                    <Button variant="contained" color="primary" size="small" startIcon={<PlayIcon />} onClick={() => handleRunWorkflow(workflow.id)} disabled={!workflow.isActive} sx={{
                  flex: 1,
                  fontSize: {
                    xs: '0.8rem',
                    sm: '0.875rem'
                  ...
                  py: {
                    ...
                    <Button variant="outlined" size="small" startIcon={<EditIcon />} sx={{
                  flex: 1,
                  fontSize: {
                    xs: '0.8rem',
                    sm: '0.875rem'
                  ...
                  py: {
                    ...
                    <IconButton size="small" onClick={() => handleToggleFavorite(workflow.id)} sx={{
        ...
        {/* Action Menu */}
        <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && Boolean(selectedWorkflow)} onClose={handleMenuClose} transformOrigin={{
        horizontal: 'right',
        vertical: 'top'
      }} anchorOrigin={{
        horizontal: 'right',
        vertical: 'bottom'
          ...
          <Divider />
          <MenuItem onClick={() => selectedWorkflow && handleDelete(selectedWorkflow)} sx={{
          color: 'error.main'
        }}>
            <DeleteIcon sx={{
            mr: 1,
        ...
        {isMobile && <Fab color="primary" aria-label="add workflow" sx={{
        position: 'fixed',
        bottom: 24,
        right: 24,
        zIndex: 1000
